 ...
 *
 * Todas são versões escurecidas da cor da marca de cada operadora. O verde da
 * Unimed, o vermelho do Bradesco e o azul da Porto Seguro, nos tons originais,
 * ficam entre 2 e 3,5:1 sobre o fundo claro — ilegíveis em corpo de texto.
 * Estes tons ficam todos acima de 4,5:1.
 *
...
export const CORES_DE_CONVENIO = [
  ...
  { chaves: ["notre dame", "notredame", "hapvida"], cor: "#8A6A00" }, // amarelo escuro
