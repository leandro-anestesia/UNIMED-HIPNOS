 ...
 *
 * ─────────────────────────────────────────────────────────────────────────────
 * A PREENCHER: os valores abaixo são provisórios, escolhidos apenas para o app
 * subir com uma aparência apresentável. Substitua por:
 *   · EQUIPE / HOSPITAL — como a equipe se chama
 *   · CORES             — as cores da equipe
 *   · public/logo-mark.png e os ícones — o logo de verdade
 * ─────────────────────────────────────────────────────────────────────────────
 */

/** Linha pequena acima do título, no cabeçalho. */
export const EQUIPE = "Equipe de Anestesiologia";

/** Hospital onde a equipe atua. Entra no <title> da aba do navegador. */
