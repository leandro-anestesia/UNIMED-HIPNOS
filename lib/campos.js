 ...
 *
 * `daGuia` marca os que a foto da guia preenche. Prontuário e convênio não
 * estão na guia: são digitados, em qualquer um dos dois caminhos.
 *
 ...
 *
 * `aprende` faz o valor digitado entrar no cadastro sozinho, ao salvar. Só o
 * convênio: o cirurgião nasce da leitura da guia, e cadastrar automaticamente
 * o que a leitura devolveu encheria a lista de erro de OCR.
 */
export const CAMPOS_DO_REGISTRO = [
  ...
  { key: "convenio", label: "Convênio", cadastroKey: "convenios", aprende: true },
